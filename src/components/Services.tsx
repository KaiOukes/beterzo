    ...
    <section id="services" className="section bg-beterzo-light">
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Trainingen */}
          <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all slide-in" style={{ transitionDelay: '100ms' }}>
          ...
          <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all slide-in" style={{ transitionDelay: '200ms' }}>
            <div className="w-16 h-16 bg-primary-50 rounded-full flex items-center justify-center mb-6">
