          ...
          <div className="container px-4 mx-auto">
            <div className="max-w-4xl">
              <h1 className="text-4xl md:text-5xl font-bold mb-6 relative">
                Privacy en veiligheid bij Beterzo
            ...
            <div className="max-w-4xl space-y-16">
              ...
              <div className="prose max-w-none">
                ...
                <p className="text-lg mt-6">
                  ...
                  beveiligde API's en met platforms die honderd procent voldoen aan de Algemene Verordening Gegevensbescherming (AVG).
                </p>
              </div>
              ...
              {/* GDPR Compliance */}
              <div>
                <h2 className="text-2xl font-bold mb-6">We voldoen aan de AVG</h2>
                <p className="text-lg mb-6">
                  Alle oplossingen die wij bouwen voldoen aan de Europese Algemene Verordening Gegevensbescherming.
